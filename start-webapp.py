...
class OptimizedStartup:
    def __init__(self, project_root: Path, args):
        ...
        self.services = {
            ...
            # Gateway health is probed inside the container, so we hit its internal 443 port and accept 401s.
            'ibkr-gateway': ServiceConfig('IBKR Gateway', 'ibkr-gateway', 'curl -k https://localhost:443/v1/api/tickle', 90, True),
